...
.   <nav>
  ...
  <script type="text/javascript">
    ...
    // //tính năng add to cart
    jQuery(document).ready(function(){
      //Khi nhấn vào button add to cart thì thuc hien phương thức
      $('.add-to-cart-mt').click(function(){
        let id = $(this).attr('data-id') //con trỏ của đối tượng đang click vào
        // alert(id)
        $.ajax({
          url: 'cart.php',
          type: 'POST', //method
      ...
      //Khi nhấn vào icon xóa trong giỏ hàng thì thực hiện phương thức
