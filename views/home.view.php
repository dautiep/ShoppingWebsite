        ...
        <div class="tp-banner">
          <ul>
            ...
            <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700">
              <!-- MAIN IMAGE -->
              <img src="public/source/images/slider/<?php echo $value->image; ?>" alt="slidebg1" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
              <!-- LAYERS -->
              <!-- LAYER NR. 1 -->
                  ...
                  <div class="featured-pro">
                    <div class="slider-items-products">
                      <div id="featured-slider" class="product-flexslider hidden-buttons">
                        ...
                        <?php 
                        foreach ($data['featuredproduct'] as $key => $value):?>
                              ...
                              <div class="product-thumbnail">
                                ...
                                <div class="pr-img-area">
                                  <a title="Ipsums Dolors Untra" href="<?php echo $value->url; ?>">
                                    <figure>
                                      <img class="first-img" src="public/source/products-images/<?php echo $value->image; ?>" alt="html template">
                                      <img class="hover-img" src="public/source/products-images/<?php echo $value->image; ?>" alt="html template">
                                    </figure>
                                  </a>
                  ...
                  <div class="top-sellers-pro">
                    <div class="slider-items-products">
                      <div id="top-sellers-slider" class="product-flexslider hidden-buttons">
                        <div class="slider-items slider-width-col4 ">
                        <?php
                        foreach ($data['topsellers'] as $key => $value):?>
                          <div class="product-item">
                            <div class="item-inner">
                              <div class="product-thumbnail">
                                <div class="icon-sale-label sale-left">Sale</div>
                              ...
                              <div class="item-info">
                                <div class="info-inner">
                                  ...
                                  <div class="item-content">
                                    ...
                                    <div class="item-price">
                                    <?php
                                    if($value->promotion_price != 0 && $value->promotion_price < $value->price):?>
                                      <div class="price-box">
                                        <p class="special-price">
                                          <span class="price-label">Special Price</span>
                                          <span class="price">
                                          <?php 
                                          $format_number = number_format($value->promotion_price, 0, ",", ".");
                                          echo $format_number . "đ";
                                           ?>
                                          </span>
                                        </p>
                                    ...
                                    <?php elseif($value->promotion_price == $value->price || $value->promotion_price == 0):?>
                                      <div class="price-box">
                                          <p class="special-price">
                                          <span class="price-label">Special Price</span>
                                          <span class="price">
        ...
        <div class="row">
              ...
              <div class="jtv-product">
                <div class="product-img">
                  <a href="<?php echo $value->url; ?>">
                    <img src="public/source/products-images/<?php echo $value->image; ?>" alt="html template">
                    <img class="secondary-img" src="public/source/products-images/<?php echo $value->image; ?>" alt="html template"> </a>
                </div>
          ...
          <div class="col-md-4 col-sm-6">
            <div class="jtv-single-cat">
              ...
              <?php foreach ($data['onsale'] as $key => $value): ?>
              <div class="jtv-product">
                <div class="product-img">
                  <a href="<?php echo $value->url; ?>">
                    <img src="public/source/products-images/<?php echo $value->image;?>" alt="html template">
